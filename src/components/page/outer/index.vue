...
export default {
  ...
  methods: {
    ...
    requestHospitalList() {
      ...
      getHospitalList({xykj: xykj, token: this.token}).then(data => {
    ...
    reuqestLowerCommunityList(obj) {
      ...
      getLowerCommunityList({xykj: xykj, token: this.token}).then(data => {
    ...
    requestDepList(obj) {
      ...
      getDepList({xykj: xykj, token: this.token}).then(data => {
    ...
    requestDoctorList(obj) {
      ...
      getDoctorList({xykj: xykj, token: this.token}).then(data => {
    ...
    requestScheduleDate(obj) {
      ...
      getScheduleDate({xykj: xykj, token: this.token}).then(data => {
    ...
    requestScheduleDateTimes(workDate) {
      ...
      getScheduleDateTimes({xykj: xykj, token: this.token}).then(data => {
    ...
    goSubmit(obj) {
      ...
      goSubmitSchedule({xykj: xykj, token: this.token}).then(data => {
    ...
    submit() {
      ...
      submitInfo({xykj: xykj, token: this.token}).then(data => {
    ...
    getToken() {
      this.$store.dispatch('task/getScheduleList', {}).then(res => {
        if (res && res.length > 0) {
